...
BasicTestingSetup::BasicTestingSetup(const std::string& chainName, bool fEfinModeIn): m_path_root(fs::temp_directory_path() / "test_bitcoin" / strprintf("%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(1 << 30))))
{
